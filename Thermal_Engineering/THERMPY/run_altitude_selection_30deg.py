"""
run_altitude_selection_30deg.py

Generates every table in docs/altitude_selection_30deg.md (thermal aside, Part A,
deliverable T1). One driver per document -- the filename is the document stem.
